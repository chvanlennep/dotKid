...
const AdrenalineTimer = ({ adrenalinePressedState, adrenalineTimeState, resetState }) => {
  ...
  useEffect(() => {
      const displayInterval = setAdrenalineTime(secondsToHms(secondsPassed.current))
...
// )
  ...
  return (
      <AppText style={styles.text}>{adrenalineTime}</AppText>
  )
}
