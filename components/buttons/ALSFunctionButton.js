...
import { Alert, StyleSheet, TouchableHighlight, TouchableOpacity, useWindowDimensions, View } from 'react-native'
...
const ALSFunctionButton = ({ intervalState, logState, resetState, style, title }) => {
